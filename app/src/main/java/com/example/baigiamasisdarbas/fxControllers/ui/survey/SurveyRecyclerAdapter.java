...
public class SurveyRecyclerAdapter extends RecyclerView.Adapter<SurveyRecyclerAdapter.MyViewHolder> {

    private ArrayList<Survey> surveysList;
    private RecyclerViewClickListener listener;

    public SurveyRecyclerAdapter(RecyclerViewClickListener listener, ArrayList<Survey> surveysList) {
    ...
    @NonNull
    @Override
    public SurveyRecyclerAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.survey_item, parent, false);
        return new MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull SurveyRecyclerAdapter.MyViewHolder holder, int position) {
